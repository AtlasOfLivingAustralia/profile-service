...
/**
 * TODO: This is a hack to workaround a bug with the elasticsearch grails plugin, where it does not trigger an index update
 * when a child object is updated. A fix has been made and a pull request created on the elasticsearch grails plugin
 * GitHub repo - once a new version of the plugin is released, this class needs to be deleted.
 *
 * The bug exists in version 0.0.4.6.
 * https://github.com/noamt/elasticsearch-grails-plugin
 *
 * Fix: https://github.com/m-r-c/elasticsearch-grails-plugin
 *
 * PR: https://github.com/noamt/elasticsearch-grails-plugin/pull/139
 */
